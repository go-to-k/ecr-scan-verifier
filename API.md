...
| <code><a href="#ecr-scan-verifier.EcrScanVerifierProps.property.memorySize">memorySize</a></code> | <code>number</code> | The amount of memory, in MB, for the Scanner Lambda function. |
...
##### `memorySize`<sup>Optional</sup> <a name="memorySize" id="ecr-scan-verifier.EcrScanVerifierProps.property.memorySize"></a>
